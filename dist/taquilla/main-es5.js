...
var ReimpresionComponent = /** @class */ (function () {
    ...
    ReimpresionComponent.prototype.checkPermisos = function () {
        var userData = this.oauthService.getIdentityClaims();
        this.imprimirCodigo = userData.permisos.some(function (access) { return access.key.includes('impresionCodigo'); });
...
var CancelarService = /** @class */ (function () {
    ...
    CancelarService.prototype.changueTicket = function (boletoAsientoId, delelteAll) {
...
var TaquillaComponent = /** @class */ (function () {
    ...
    TaquillaComponent.prototype.checkPermisos = function () {
        var userData = this.oauthService.getIdentityClaims();
        this.reimpresionAccess = userData.permisos.some(function (access) { return access.key.includes('reimpresion'); });
        this.apartadosAccess = userData.permisos.some(function (access) { return access.key.includes('apartar'); });
        this.cambioAccess = userData.permisos.some(function (access) { return access.key.includes('cambio'); });
        console.log(userData);
    };
